...
wget https://raw.githubusercontent.com/CoreShiftD/CoreShift-GKI-Common/refs/heads/main/scripts/disable-kmi-check.sh;wait;chmod +x disable-kmi-check.sh;bash disable-kmi-check.sh
#Compile
cd ../
